--Devido à formatação diferente das tabelas disponibilizadas no Excel, algumas linhas e colunas ficaram desregulares na hora da importação. 
--Logo, foi nescessário efetuar uma limpeza: 
...
-- OBS3: Após a limpeza dos dados, iniciei com as resoluções dos problemas.
